...
class SimulationState:
    ...
    def __init__(self, model, data, ee_site_name='arm_hand_pinch'):
        """
        ...
        Args:
            model: MuJoCo model
            data: MuJoCo data
            ee_site_name: Name of the canonical end-effector site
        """
        self.model = model
        self.data = data
    ...
    def get_end_effector_pose(self):
        ...
        try:
            ...
            R = self.data.site_xmat[site_id].copy().reshape(3, 3)
            quat = self._mat_to_quat(R)
